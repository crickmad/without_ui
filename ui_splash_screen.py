...
"color: rgb(155, 155, 255);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; font-size:40pt; color:#9b9bff;\">ZIA</span></p></body></html>", None))
        self.labelPercentage.setText(QCoreApplication.translate("SplashScreen", u"<p><span style=\" font-size:38pt;\">0</span><span style=\" font-size:28pt; vertical-align:super;\">%</span></p>", None))
        self.labelLoadingInfo.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        #self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"by: Noob tech", None))
    # retranslateUi
